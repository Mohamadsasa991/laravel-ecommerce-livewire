    ...
    <div>
    <h1 class="block text-3xl font-bold text-gray-800 sm:text-4xl lg:text-6xl lg:leading-tight dark:text-white">Start your journey with <span class="text-blue-600">Coders</span></h1>
    ...
    <h1 class="text-5xl font-bold dark:text-gray-800"> Browse Popular<span class="text-blue-500"> Brands
    </span> </h1>
            ...
            <div class="p-4 md:p-5">
                <div class="flex justify-between items-center">
                    <div class="flex items-center">
                        <img class="h-[2.375rem] w-[2.375rem] rounded-full" src="{{  asset('storage/'.$category->image) }}" alt="Image Description">
                        <div class="ms-3">
