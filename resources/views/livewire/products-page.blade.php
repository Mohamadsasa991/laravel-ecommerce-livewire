...
<div class="w-full pr-2 lg:w-1/4 lg:block">
    ...
    <ul>
        ...
        <label for="on_sale" class="flex items-center dark:text-gray-300">
            <input id="on_sale" value="1" wire:model.live="on_sale" type="checkbox" class="w-4 h-4 mr-2">
    ...
    <div class="w-16 pb-2 mb-6 border-b border-rose-600 dark:border-gray-400"></div>
    <div>
        <div class="text-white">{{Number::currency($price_range,'USD')}}</div>
        <input wire:model.live="price_range" type="range" max="500000" value="300000" step="1000" class="w-full h-1 mb-4 bg-blue-100 rounded appearance-none cursor-pointer" max="500000" value="100000" step="100000">
